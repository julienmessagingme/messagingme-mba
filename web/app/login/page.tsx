      ...
      <div className="w-full max-w-sm">
        ...
        <form onSubmit={onSubmit} className="space-y-4 rounded-carte border border-ink-200 bg-white p-6">
          <div>
            ...
            <label htmlFor="login-email" className="mb-1 block text-sm font-medium text-ink-900">Email</label>
            <input
              id="login-email"
              type="email"
              required
          ...
          <div>
            <label htmlFor="login-password" className="mb-1 block text-sm font-medium text-ink-900">{t('Mot de passe', 'Password')}</label>
            <input
              id="login-password"
              type="password"
              required
