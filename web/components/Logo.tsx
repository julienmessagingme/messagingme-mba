/**
 * Logo Engage Me : 3 brins à symétrie parfaite (0/120/240°), un canal par couleur
...
export function Logo({ className, mono = false }: { className?: string; mono?: boolean }) {
  ...
  return (
    <svg viewBox="0 0 160 160" className={className} xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Engage Me">
