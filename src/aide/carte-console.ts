...
export const CARTE_CONSOLE: EcranAide[] = [
  ...
  {"cle":"mba-guide","href":"/mba","fr":"Guide","en":"Guide","acces":"admin","chemin":["AI Agent","MBA"]},
  {"cle":"mba-settings","href":"/mba/parametres","fr":"Paramètres","en":"Settings","acces":"admin","chemin":["AI Agent","MBA"]},
